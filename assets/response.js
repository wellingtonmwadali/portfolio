...
function getBotResponse(input){
    if(input == "hello"){
        ...
        return '<a href="https://github.com/wellingtonmwadali">https://github.com/wellingtonmwadali</a>'
    }
    else if (input == "linkedin"){
        return '<a href="https://www.linkedin.com/in/wellington-mwadali-/">https://www.linkedin.com/in/wellington-mwadali-'
    }
    else if (input == "twitter"){
        return '<a href ="https://twitter.com/mwadzaliii">https://twitter.com/mwadzaliii</a>'
    }
    else if (input == "Humour"){
        return "dry, dark or intelligent?"
    }
    else if(input == "dry"){
        return "Doctor at my check up asked me if I had 'any feelings of depression or anxiety'and I said 'don't we all'and she said 'no'.lol"
    }
    else if(input == "dark"){
